...
if (isset($_GET['opc'])) {
    ...
    a {
        ...
        text-decoration: none;
                    ...
                    echo '<p class="cat-origen pb-1">idventa=' . $curso['id_detalle_venta'] . '</p>';
                    echo '<a href="../controller/pdf/ctrlPDF.php?opc=2&id_venta=' . $curso['id_detalle_venta'] . '&fecha=' . $curso['fecha'] . '" target="_blank">aaaaa</a>';
            ...
            break;
        case '2': //imprimir pdf
            $id_venta = isset($_GET['id_detalle_venta']) && isset($_GET['fecha']) ? $_GET['id_detalle_venta'] : NULL;
